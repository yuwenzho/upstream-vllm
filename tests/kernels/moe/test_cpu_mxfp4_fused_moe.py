...
if not hasattr(torch.ops._C, "fused_experts_mxfp4_cpu"):
    pytest.skip("fused_experts_mxfp4_cpu op not available", allow_module_level=True)
...
def test_mxfp4_cpu_fused_moe(M, N, K, E, topk, seed):
    ...
    # Kernel
    out = ops.cpu_fused_experts_mxfp4(
        a.clone(),
        pw1,
        pw2,
        topk_weight,
