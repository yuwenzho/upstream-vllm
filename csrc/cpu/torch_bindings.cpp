...
at::Tensor fused_experts_mxfp4_cpu(at::Tensor& hidden_states, at::Tensor& w1,
                                   at::Tensor& w2, at::Tensor& topk_weights,
                                   at::Tensor& topk_ids, bool inplace,
                                   at::Tensor& w1_scale, at::Tensor& w2_scale,
...
// SHM CCL
  ...
  ops.def(
      "fused_experts_mxfp4_cpu(Tensor! hidden_states, Tensor! w1, Tensor! w2, "
      "Tensor topk_weights, Tensor topk_ids, bool inplace, "
      "Tensor! w1_scale, Tensor! w2_scale, "
      "Tensor? w1_bias, Tensor? w2_bias, "
      "float? alpha, float? limit, bool is_vnni) -> Tensor");
  ops.impl("fused_experts_mxfp4_cpu", torch::kCPU, &fused_experts_mxfp4_cpu);
  ops.def(
